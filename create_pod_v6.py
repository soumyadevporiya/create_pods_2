...
for i in range(2, 4):
    ...
    image = 'gcr.io/tough-anagram-388502/ns_monolith_parallel_reader_v5:latest'
    ...
    node_name = ''
    if i <= 2:
        node_name = 'gke-cluster-1-default-pool-ec4190bb-0sdx'
    elif i <= 3:
        node_name = 'gke-cluster-1-default-pool-ec4190bb-zw41'
